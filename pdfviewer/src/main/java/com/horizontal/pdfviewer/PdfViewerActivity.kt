...
import com.horizontal.pdfviewer.databinding.ActivityPdfViewerBinding
import com.horizontal.pdfviewer.util.FileUtils.createPdfDocumentUri
import com.horizontal.pdfviewer.util.FileUtils.fileFromAsset
import com.horizontal.pdfviewer.util.FileUtils.uriToFile
import com.horizontal.pdfviewer.util.NetworkUtil.checkInternetConnection
import com.horizontal.pdfviewer.util.PdfEngine
import com.horizontal.pdfviewer.util.saveTo
import java.io.File
...
class PdfViewerActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        fun launchPdfFromUrl(
            ...
            isPDFFromPath = false
            SAVE_TO_DOWNLOADS = saveTo == com.horizontal.pdfviewer.util.saveTo.DOWNLOADS
            return intent
        }
