...
@Singleton
class DivviupUtils @Inject constructor() {
    ...
    companion object {
        ...
        fun runInstallEvent(context: Context) {
            ...
            if (!CommonPreferences.hasAcceptedAnalytics() || CommonPreferences.isInstallMetricSent() || isDebugBuild(
                    context
                )
            ) return
            Executors.newSingleThreadExecutor().execute {
        ...
        fun runQuickDeleteEvent(context: Context) {
            ...
            Executors.newSingleThreadExecutor().execute {
                try {
                    val taskId =
                        TaskId.parse(context.getString(R.string.divviup_count_quick_delete_id))
                    val leaderEndpoint: URI =
                        URI.create(context.getString(R.string.divviup_leader))
                    val helperEndpoint: URI =
                        URI.create(context.getString(R.string.divviup_helper))
        ...
        fun runCamouflageEnabledEvent(context: Context) {
            ...
            Executors.newSingleThreadExecutor().execute {
                try {
                    val taskId =
                        TaskId.parse(context.getString(R.string.divviup_count_camouflage_id))
                    val leaderEndpoint: URI =
                        URI.create(context.getString(R.string.divviup_leader))
                    val helperEndpoint: URI =
                        URI.create(context.getString(R.string.divviup_helper))
        ...
        fun runReportSentEvent(context: Context) {
            ...
            Executors.newSingleThreadExecutor().execute {
                try {
                    val taskId =
                        TaskId.parse(context.getString(R.string.divviup_count_report_sent_id))
                    val leaderEndpoint: URI =
                        URI.create(context.getString(R.string.divviup_leader))
                    val helperEndpoint: URI =
                        URI.create(context.getString(R.string.divviup_helper))
        ...
        fun runUwaziSentEvent(context: Context) {
            ...
            Executors.newSingleThreadExecutor().execute {
                try {
                    val taskId =
                        TaskId.parse(context.getString(R.string.divviup_count_uwazi_sent_id))
                    val leaderEndpoint: URI =
                        URI.create(context.getString(R.string.divviup_leader))
                    val helperEndpoint: URI =
                        URI.create(context.getString(R.string.divviup_helper))
