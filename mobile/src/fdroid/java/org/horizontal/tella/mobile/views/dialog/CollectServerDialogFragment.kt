...
/**
 * F-Droid: Collect server dialog without Google Play Services (no ProviderInstaller).
 */
@AndroidEntryPoint
class CollectServerDialogFragment : AppCompatDialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val dialog = Dialog(requireActivity()).apply {
            ...
            setContentView(root)
            window?.apply {
                setBackgroundDrawable(requireContext().resources.getDrawable(R.drawable.collect_server_dialog_layout_background))
