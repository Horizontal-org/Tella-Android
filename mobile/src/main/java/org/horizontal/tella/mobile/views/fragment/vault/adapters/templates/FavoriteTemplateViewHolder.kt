...
class FavoriteTemplateViewHolder(val view: View) : BaseViewHolder<UwaziTemplate>(view) {
       private lateinit var formsTitleTextView : TextView
    override fun bind(item: UwaziTemplate, vaultClickListener: VaultClickListener) {
