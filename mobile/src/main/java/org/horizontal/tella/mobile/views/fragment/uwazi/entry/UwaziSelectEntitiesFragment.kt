...
import org.horizontal.tella.mobile.data.uwazi.UwaziConstants.UWAZI_RELATION_SHIP_REQUEST_KEY
import org.horizontal.tella.mobile.databinding.UwaziSelectEntitiesFragmentBinding
import org.horizontal.tella.mobile.presentation.uwazi.UwaziRelationShipEntity
import org.horizontal.tella.mobile.views.base_ui.BaseBindingDialogFragment
import org.horizontal.tella.mobile.views.fragment.uwazi.widgets.searchable_multi_select.SearchableAdapter
import org.horizontal.tella.mobile.views.fragment.uwazi.widgets.searchable_multi_select.SearchableItem
...
class UwaziSelectEntitiesFragment :
    ...
    private fun initializeData() {
        ...
        arguments?.getString(UWAZI_ENTRY_PROMPT_TITLE)?.let {
            promptTitle = it
        }
    }
