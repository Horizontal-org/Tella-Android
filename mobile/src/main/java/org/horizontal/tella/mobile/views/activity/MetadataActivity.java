...
public abstract class MetadataActivity extends BaseLockActivity implements SensorEventListener {
    ...
    @Nullable
    private LocationSettingsCheckDoneListener pendingLocationSettingsListener;
    ...
    private void resumePendingLocationSettingsCheck() {
        ...
        LocationSettingsCheckDoneListener listener = pendingLocationSettingsListener;
        pendingLocationSettingsListener = null;
        listener.onContinue();
    }

    protected void showGpsMetadataDialog(
            final int requestCode,
            final LocationSettingsCheckDoneListener listener
    ) {
