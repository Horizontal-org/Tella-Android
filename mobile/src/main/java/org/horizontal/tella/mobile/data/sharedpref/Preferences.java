package org.horizontal.tella.mobile.data.sharedpref;


import static org.horizontal.tella.mobile.data.sharedpref.SharedPrefs.FAILED_UNLOCK_OPTION;
import static org.horizontal.tella.mobile.data.sharedpref.SharedPrefs.HAS_IMPROVEMENT_ACCEPTED;
import static org.horizontal.tella.mobile.data.sharedpref.SharedPrefs.INSTALL_METRIC_SENT;
import static org.horizontal.tella.mobile.data.sharedpref.SharedPrefs.IS_FRESH_INSTALL;
import static org.horizontal.tella.mobile.data.sharedpref.SharedPrefs.IS_MIGRATED_MAIN_DB;
import static org.horizontal.tella.mobile.data.sharedpref.SharedPrefs.REMAINING_UNLOCK_ATTEMPTS;
import static org.horizontal.tella.mobile.data.sharedpref.SharedPrefs.SHOW_IMPROVEMENT_SECTION;
import static org.horizontal.tella.mobile.data.sharedpref.SharedPrefs.SHOW_REMAINING_UNLOCK_ATTEMPTS;
import static org.horizontal.tella.mobile.data.sharedpref.SharedPrefs.TIME_IMPROVEMENT_ACCEPTED;
import static org.horizontal.tella.mobile.data.sharedpref.SharedPrefs.TIME_SPENT;
import static org.horizontal.tella.mobile.data.sharedpref.SharedPrefs.UNLOCK_TIME;
