...
class DropBoxConnectFlowActivity : BaseActivity() {
    ...
    override fun onTopResumedActivityChanged(onTop: Boolean) {
        ...
        val officialAuthIntent = DropboxAuthIntent.buildOfficialAuthIntent(
            authActivity = this@DropBoxConnectFlowActivity,
            mState = mState,
    ...
    public companion object {
        private val TAG = DropBoxConnectFlowActivity::class.java.name
        ...
        public fun makeIntent(
            ...
            return Intent(context, DropBoxConnectFlowActivity::class.java)
        }
        ...
        public fun checkAppBeforeAuth(
            ...
            check(0 != activities.size) {
                "URI scheme in your app's " +
                        ...
                        DropBoxConnectFlowActivity::class.java.name + " with the " +
                        "scheme: " + scheme
            }
            if (activities.size > 1) {
                ...
                check(!(resolveInfo?.activityInfo == null || context.packageName != resolveInfo.activityInfo.packageName)) {
                    "There must be a " +
                            DropBoxConnectFlowActivity::class.java.name + " within your app's package " +
