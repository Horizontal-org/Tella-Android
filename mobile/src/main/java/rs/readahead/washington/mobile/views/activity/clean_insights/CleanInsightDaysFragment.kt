...
class CleanInsightDaysFragment : BaseFragment() {
    ...
    companion object {
        ...
        fun newInstance(onNext: () -> Unit, onPrevious: () -> Unit) =
            CleanInsightDaysFragment().apply {
                this.onNext = onNext
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_clean_insights_days, container, false)
    }
