...
public interface UserAccountManager extends CurrentAccountProvider {
    ...
    /**
     * Check if Nextcloud account is registered in {@link AccountManager}
     *
    ...
    static String getDisplayName(User user) {
        return AccountManager.get(MyApplication.getAppContext()).getUserData(user.toPlatformAccount(),
