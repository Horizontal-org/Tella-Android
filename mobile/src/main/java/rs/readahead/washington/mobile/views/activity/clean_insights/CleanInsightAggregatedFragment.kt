...
class CleanInsightAggregatedFragment : BaseFragment() {
    ...
    companion object {
        ...
        fun newInstance(onNext: () -> Unit, onPrevious: () -> Unit) =
            CleanInsightAggregatedFragment().apply {
                this.onNext = onNext
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_clean_insights_data_aggregated, container, false)
    }
