...
public class CamouflageManager {
    ...
    private CamouflageManager() {
        ...
        options.add(new CamouflageOption(getOptionAlias("Camera"), R.drawable.camera, R.string.camera));
        ...
        options.add(new CamouflageOption(getOptionAlias("Weather"), R.drawable.weather, R.string.weather));
        options.add(new CamouflageOption(getOptionAlias("WeatherNow"), R.drawable.weather_now, R.string.weather_now));
        options.add(new CamouflageOption(getOptionAlias("LocalWeather"), R.drawable.local_weather, R.string.local_weather));
        options.add(new CamouflageOption(getOptionAlias("Calculator"), R.drawable.calculator, R.string.calculator));
        options.add(new CamouflageOption(getOptionAlias("EasyMath"), R.drawable.easy_math, R.string.easy_math));
    ...
    public CharSequence getLauncherName(@NonNull Context context) {
        try {
            ...
            return context.getResources().getString(R.string.ra_name_not_found);
        }
    }
