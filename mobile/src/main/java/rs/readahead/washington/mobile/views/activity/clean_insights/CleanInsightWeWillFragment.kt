...
class CleanInsightWeWillFragment : BaseFragment() {
    ...
    companion object {
        ...
        fun newInstance(onNext: () -> Unit, onPrevious: () -> Unit) =
            CleanInsightWeWillFragment().apply {
                this.onNext = onNext
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_clean_insights_we_will, container, false)
    }
