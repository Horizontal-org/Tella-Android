...
import rs.readahead.washington.mobile.views.dialog.dropbox.DropBoxConnectFlowActivity.Companion.checkAppBeforeAuth
import rs.readahead.washington.mobile.views.dialog.dropbox.DropBoxConnectFlowActivity.Companion.makeIntent
...
public class Auth {
    companion object {
        ...
        public fun getUid(): String? {
            ...
            val data = DropBoxConnectFlowActivity.result
        ...
        public fun getDbxCredential(): DbxCredential? {
            val data = DropBoxConnectFlowActivity.result ?: return null
