...
public class AccountAuthenticator extends AbstractAccountAuthenticator {
    ...
    public Bundle addAccount(AccountAuthenticatorResponse response,
        ...
        Account[] accounts = accountManager.getAccountsByType(MyApplication.getAccountType(mContext));
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response,
        ...
        String accessToken;
        if (authTokenType.equals(AccountTypeUtils.getAuthTokenTypePass(MyApplication.getAccountType(mContext)))) {
        ...
        if (accessToken != null) {
            ...
            result.putString(AccountManager.KEY_ACCOUNT_TYPE, MyApplication.getAccountType(mContext));
    ...
    private void validateAccountType(String type) throws UnsupportedAccountTypeException {
        if (!type.equals(MyApplication.getAccountType(mContext))) {
            throw new UnsupportedAccountTypeException();
        }
    }

    private void validateAuthTokenType(String authTokenType) throws UnsupportedAuthTokenTypeException {
        String accountType = MyApplication.getAccountType(mContext);
